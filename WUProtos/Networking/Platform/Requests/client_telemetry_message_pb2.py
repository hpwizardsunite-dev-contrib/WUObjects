...
# source: wuprotos/networking/platform/requests/client_telemetry_message.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='wuprotos/networking/platform/requests/client_telemetry_message.proto',
  package='wuprotos.networking.platform.requests',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nDwuprotos/networking/platform/requests/client_telemetry_message.proto\x12%wuprotos.networking.platform.requests\"\x18\n\x16\x43lientTelemetryMessageb\x06proto3')
)
...
ClientTelemetryMessage = _reflection.GeneratedProtocolMessageType('ClientTelemetryMessage', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.platform.requests.client_telemetry_message_pb2'
