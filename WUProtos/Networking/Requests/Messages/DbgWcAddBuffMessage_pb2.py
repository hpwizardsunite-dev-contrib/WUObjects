...
DbgWcAddBuffMessage = _reflection.GeneratedProtocolMessageType('DbgWcAddBuffMessage', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Requests.Messages.DbgWcAddBuffMessage_pb2'
