...
DbgStartEncounterMessage = _reflection.GeneratedProtocolMessageType('DbgStartEncounterMessage', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Requests.Messages.DbgStartEncounterMessage_pb2'
