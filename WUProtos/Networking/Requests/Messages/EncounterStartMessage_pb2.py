...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='WUProtos/Networking/Requests/Messages/EncounterStartMessage.proto',
  package='WUProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nAWUProtos/Networking/Requests/Messages/EncounterStartMessage.proto\x12%WUProtos.Networking.Requests.Messages\"1\n\x15\x45ncounterStartMessage\x12\x18\n\x10\x65ncounter_ticket\x18\x01 \x01(\x0c\x62\x06proto3')
)
...
EncounterStartMessage = _reflection.GeneratedProtocolMessageType('EncounterStartMessage', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Requests.Messages.EncounterStartMessage_pb2'
