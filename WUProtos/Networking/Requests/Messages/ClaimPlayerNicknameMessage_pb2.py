...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='WUProtos/Networking/Requests/Messages/ClaimPlayerNicknameMessage.proto',
  package='WUProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nFWUProtos/Networking/Requests/Messages/ClaimPlayerNicknameMessage.proto\x12%WUProtos.Networking.Requests.Messages\"6\n\x1a\x43laimPlayerNicknameMessage\x12\x18\n\x10\x64\x65sired_nickname\x18\x01 \x01(\tb\x06proto3')
)
...
ClaimPlayerNicknameMessage = _reflection.GeneratedProtocolMessageType('ClaimPlayerNicknameMessage', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Requests.Messages.ClaimPlayerNicknameMessage_pb2'
