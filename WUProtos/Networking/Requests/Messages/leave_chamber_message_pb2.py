...
# source: wuprotos/networking/requests/messages/leave_chamber_message.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='wuprotos/networking/requests/messages/leave_chamber_message.proto',
  package='wuprotos.networking.requests.messages',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nAwuprotos/networking/requests/messages/leave_chamber_message.proto\x12%wuprotos.networking.requests.messages\"\x15\n\x13LeaveChamberMessageb\x06proto3')
)
...
LeaveChamberMessage = _reflection.GeneratedProtocolMessageType('LeaveChamberMessage', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.requests.messages.leave_chamber_message_pb2'
