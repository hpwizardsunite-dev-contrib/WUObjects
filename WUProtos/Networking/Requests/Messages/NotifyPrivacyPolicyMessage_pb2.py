...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='WUProtos/Networking/Requests/Messages/NotifyPrivacyPolicyMessage.proto',
  package='WUProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nFWUProtos/Networking/Requests/Messages/NotifyPrivacyPolicyMessage.proto\x12%WUProtos.Networking.Requests.Messages\"\x1c\n\x1aNotifyPrivacyPolicyMessageb\x06proto3')
)
...
NotifyPrivacyPolicyMessage = _reflection.GeneratedProtocolMessageType('NotifyPrivacyPolicyMessage', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Requests.Messages.NotifyPrivacyPolicyMessage_pb2'
