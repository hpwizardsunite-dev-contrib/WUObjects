...
SubmitNewPoiMessage = _reflection.GeneratedProtocolMessageType('SubmitNewPoiMessage', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Requests.Messages.SubmitNewPoiMessage_pb2'
