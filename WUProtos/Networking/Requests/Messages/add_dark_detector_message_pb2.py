...
# source: wuprotos/networking/requests/messages/add_dark_detector_message.proto
...
AddDarkDetectorMessage = _reflection.GeneratedProtocolMessageType('AddDarkDetectorMessage', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.requests.messages.add_dark_detector_message_pb2'
