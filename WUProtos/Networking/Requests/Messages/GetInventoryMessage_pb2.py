...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='WUProtos/Networking/Requests/Messages/GetInventoryMessage.proto',
  package='WUProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n?WUProtos/Networking/Requests/Messages/GetInventoryMessage.proto\x12%WUProtos.Networking.Requests.Messages\"/\n\x13GetInventoryMessage\x12\x18\n\x10timestamp_millis\x18\x01 \x01(\x03\x62\x06proto3')
)
...
GetInventoryMessage = _reflection.GeneratedProtocolMessageType('GetInventoryMessage', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Requests.Messages.GetInventoryMessage_pb2'
