...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='WUProtos/Networking/Requests/Messages/UsePotionMessage.proto',
  package='WUProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n<WUProtos/Networking/Requests/Messages/UsePotionMessage.proto\x12%WUProtos.Networking.Requests.Messages\"%\n\x10UsePotionMessage\x12\x11\n\tpotion_id\x18\x01 \x01(\tb\x06proto3')
)
...
UsePotionMessage = _reflection.GeneratedProtocolMessageType('UsePotionMessage', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Requests.Messages.UsePotionMessage_pb2'
