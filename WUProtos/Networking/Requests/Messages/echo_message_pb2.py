...
# source: wuprotos/networking/requests/messages/echo_message.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='wuprotos/networking/requests/messages/echo_message.proto',
  package='wuprotos.networking.requests.messages',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n8wuprotos/networking/requests/messages/echo_message.proto\x12%wuprotos.networking.requests.messages\"\r\n\x0b\x45\x63hoMessageb\x06proto3')
)
...
EchoMessage = _reflection.GeneratedProtocolMessageType('EchoMessage', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.requests.messages.echo_message_pb2'
