...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='WUProtos/Networking/Requests/Messages/QuestAcquireDailiesMessage.proto',
  package='WUProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nFWUProtos/Networking/Requests/Messages/QuestAcquireDailiesMessage.proto\x12%WUProtos.Networking.Requests.Messages\"\x1c\n\x1aQuestAcquireDailiesMessageb\x06proto3')
)
...
QuestAcquireDailiesMessage = _reflection.GeneratedProtocolMessageType('QuestAcquireDailiesMessage', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Requests.Messages.QuestAcquireDailiesMessage_pb2'
