...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='WUProtos/Networking/Responses/CollectIngredientResponse.proto',
  package='WUProtos.Networking.Responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n=WUProtos/Networking/Responses/CollectIngredientResponse.proto\x12\x1dWUProtos.Networking.Responses\x1a\'WUProtos/Data/Loot/LootCollection.proto\"\xb3\x02\n\x19\x43ollectIngredientResponse\x12`\n\x06result\x18\x01 \x01(\x0e\x32P.WUProtos.Networking.Responses.CollectIngredientResponse.CollectIngredientResult\x12\x33\n\x07rewards\x18\x02 \x01(\x0b\x32\".WUProtos.Data.Loot.LootCollection\"\x7f\n\x17\x43ollectIngredientResult\x12\x0b\n\x07UNKNOWN\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x0e\n\nBAD_TICKET\x10\x02\x12\x10\n\x0cNOT_IN_RANGE\x10\x03\x12\x15\n\x11\x41LREADY_COLLECTED\x10\x04\x12\x11\n\rFULL_CAPACITY\x10\x05\x62\x06proto3')
  ,
...
_COLLECTINGREDIENTRESPONSE.fields_by_name['rewards'].message_type = WUProtos_dot_Data_dot_Loot_dot_LootCollection__pb2._LOOTCOLLECTION
...
CollectIngredientResponse = _reflection.GeneratedProtocolMessageType('CollectIngredientResponse', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Responses.CollectIngredientResponse_pb2'
