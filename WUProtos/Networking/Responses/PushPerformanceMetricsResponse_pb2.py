...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='WUProtos/Networking/Responses/PushPerformanceMetricsResponse.proto',
  package='WUProtos.Networking.Responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nBWUProtos/Networking/Responses/PushPerformanceMetricsResponse.proto\x12\x1dWUProtos.Networking.Responses\" \n\x1ePushPerformanceMetricsResponseb\x06proto3')
)
...
PushPerformanceMetricsResponse = _reflection.GeneratedProtocolMessageType('PushPerformanceMetricsResponse', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Responses.PushPerformanceMetricsResponse_pb2'
