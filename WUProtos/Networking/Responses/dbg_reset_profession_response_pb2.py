...
# source: wuprotos/networking/responses/dbg_reset_profession_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='wuprotos/networking/responses/dbg_reset_profession_response.proto',
  package='wuprotos.networking.responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nAwuprotos/networking/responses/dbg_reset_profession_response.proto\x12\x1dwuprotos.networking.responses\"-\n\x1a\x44\x62gResetProfessionResponse\x12\x0f\n\x07success\x18\x01 \x01(\x08\x62\x06proto3')
)
...
DbgResetProfessionResponse = _reflection.GeneratedProtocolMessageType('DbgResetProfessionResponse', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.responses.dbg_reset_profession_response_pb2'
