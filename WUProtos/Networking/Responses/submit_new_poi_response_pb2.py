...
# source: wuprotos/networking/responses/submit_new_poi_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='wuprotos/networking/responses/submit_new_poi_response.proto',
  package='wuprotos.networking.responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n;wuprotos/networking/responses/submit_new_poi_response.proto\x12\x1dwuprotos.networking.responses\"\xf6\x01\n\x14SubmitNewPoiResponse\x12J\n\x06status\x18\x01 \x01(\x0e\x32:.wuprotos.networking.responses.SubmitNewPoiResponse.Status\x12\x0f\n\x07message\x18\x02 \x03(\t\"\x80\x01\n\x06Status\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x0b\n\x07\x46\x41ILURE\x10\x02\x12\x12\n\x0eINTERNAL_ERROR\x10\x03\x12\x1f\n\x1bTOO_MANY_RECENT_SUBMISSIONS\x10\x04\x12\x11\n\rINVALID_INPUT\x10\x05\x12\t\n\x05MINOR\x10\x06\x62\x06proto3')
)
...
_SUBMITNEWPOIRESPONSE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='wuprotos.networking.responses.SubmitNewPoiResponse.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SUBMITNEWPOIRESPONSE = _descriptor.Descriptor(
  ...
  full_name='wuprotos.networking.responses.SubmitNewPoiResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='wuprotos.networking.responses.SubmitNewPoiResponse.status', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='message', full_name='wuprotos.networking.responses.SubmitNewPoiResponse.message', index=1,
...
SubmitNewPoiResponse = _reflection.GeneratedProtocolMessageType('SubmitNewPoiResponse', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.responses.submit_new_poi_response_pb2'
  # @@protoc_insertion_point(class_scope:wuprotos.networking.responses.SubmitNewPoiResponse)
  ))
