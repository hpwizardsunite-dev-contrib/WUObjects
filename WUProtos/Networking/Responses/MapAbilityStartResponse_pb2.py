...
MapAbilityStartResponse = _reflection.GeneratedProtocolMessageType('MapAbilityStartResponse', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Responses.MapAbilityStartResponse_pb2'
