...
PurchaseSkuResponse = _reflection.GeneratedProtocolMessageType('PurchaseSkuResponse', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Responses.PurchaseSkuResponse_pb2'
