...
ClaimPlayerNicknameResponse = _reflection.GeneratedProtocolMessageType('ClaimPlayerNicknameResponse', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Networking.Responses.ClaimPlayerNicknameResponse_pb2'
