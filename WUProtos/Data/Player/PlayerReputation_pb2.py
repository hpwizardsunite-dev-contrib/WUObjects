...
PlayerReputation = _reflection.GeneratedProtocolMessageType('PlayerReputation', (_message.Message,), dict(
  ...
  __module__ = 'WUProtos.Data.Player.PlayerReputation_pb2'
