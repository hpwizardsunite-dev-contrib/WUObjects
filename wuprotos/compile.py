...
def merge_protos(protos):
    ...
    for proto_path in protos:
        ...
        for proto in proto_folder:
            ...
            for import_path, import_is_public in imports:
                if import_path.startswith('WUProtos'):
...
if args.language == 'js':
    namespace = 'com.github.furtif.wuprotos'
    path = 'com/github/furtif/wuprotos'
    merge = False
    path_lower = True
    file_lower = True
    package_lower = True
    ...
    namespace = 'com.github.furtif.wuprotos'
    path = 'github.com/furtif/wuprotos'
    merge = False
    path_lower = True
    file_lower = True
    package_lower = True
...
if args.language == 'js':
    options = 'library=wuprotos,binary,error_on_name_conflict'
