...
# source: wuprotos/data/event/sync_requested_event_params.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='wuprotos/data/event/sync_requested_event_params.proto',
  package='wuprotos.data.event',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n5wuprotos/data/event/sync_requested_event_params.proto\x12\x13wuprotos.data.event\"\x1a\n\x18SyncRequestedEventParamsb\x06proto3')
)
...
SyncRequestedEventParams = _reflection.GeneratedProtocolMessageType('SyncRequestedEventParams', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.data.event.sync_requested_event_params_pb2'
