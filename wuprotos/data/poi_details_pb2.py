...
# source: wuprotos/data/poi_details.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='wuprotos/data/poi_details.proto',
  package='wuprotos.data',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n\x1fwuprotos/data/poi_details.proto\x12\rwuprotos.data\"C\n\nPoiDetails\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x13\n\x0b\x64\x65scription\x18\x02 \x01(\t\x12\x12\n\nimage_urls\x18\x03 \x03(\tb\x06proto3')
)
...
PoiDetails = _reflection.GeneratedProtocolMessageType('PoiDetails', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.data.poi_details_pb2'
