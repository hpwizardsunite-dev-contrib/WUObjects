...
# source: wuprotos/data/client/client_wand_length.proto
...
ClientWandLength = _reflection.GeneratedProtocolMessageType('ClientWandLength', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.data.client.client_wand_length_pb2'
