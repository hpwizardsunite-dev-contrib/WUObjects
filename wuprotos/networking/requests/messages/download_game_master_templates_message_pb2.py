...
# source: wuprotos/networking/requests/messages/download_game_master_templates_message.proto
...
DownloadGameMasterTemplatesMessage = _reflection.GeneratedProtocolMessageType('DownloadGameMasterTemplatesMessage', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.requests.messages.download_game_master_templates_message_pb2'
