...
# source: wuprotos/networking/requests/messages/cast_spell_for_growing_message.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='wuprotos/networking/requests/messages/cast_spell_for_growing_message.proto',
  package='wuprotos.networking.requests.messages',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nJwuprotos/networking/requests/messages/cast_spell_for_growing_message.proto\x12%wuprotos.networking.requests.messages\"V\n\x1a\x43\x61stSpellForGrowingMessage\x12\x12\n\noutpost_id\x18\x01 \x01(\t\x12\x0e\n\x06pot_id\x18\x02 \x01(\t\x12\x14\n\x0cspell_energy\x18\x03 \x01(\x05\x62\x06proto3')
)
...
CastSpellForGrowingMessage = _reflection.GeneratedProtocolMessageType('CastSpellForGrowingMessage', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.requests.messages.cast_spell_for_growing_message_pb2'
