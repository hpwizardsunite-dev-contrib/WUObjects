...
# source: wuprotos/networking/platform/responses/ping_response.proto
...
PingResponse = _reflection.GeneratedProtocolMessageType('PingResponse', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.platform.responses.ping_response_pb2'
