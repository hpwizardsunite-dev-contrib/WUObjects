...
# source: wuprotos/networking/platform/responses/register_push_notification_response.proto
...
RegisterPushNotificationResponse = _reflection.GeneratedProtocolMessageType('RegisterPushNotificationResponse', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.platform.responses.register_push_notification_response_pb2'
