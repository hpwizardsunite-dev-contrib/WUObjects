...
# source: wuprotos/networking/responses/cast_spell_for_growing_response.proto
...
CastSpellForGrowingResponse = _reflection.GeneratedProtocolMessageType('CastSpellForGrowingResponse', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.responses.cast_spell_for_growing_response_pb2'
