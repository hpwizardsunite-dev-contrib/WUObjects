...
# source: wuprotos/networking/responses/player_help_info_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='wuprotos/networking/responses/player_help_info_response.proto',
  package='wuprotos.networking.responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n=wuprotos/networking/responses/player_help_info_response.proto\x12\x1dwuprotos.networking.responses\"+\n\x16PlayerHelpInfoResponse\x12\x11\n\tplayer_id\x18\x01 \x01(\tb\x06proto3')
)
...
PlayerHelpInfoResponse = _reflection.GeneratedProtocolMessageType('PlayerHelpInfoResponse', (_message.Message,), dict(
  ...
  __module__ = 'wuprotos.networking.responses.player_help_info_response_pb2'
